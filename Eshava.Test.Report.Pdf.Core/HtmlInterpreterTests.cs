...
";
			...
			var result = _classUnderTest.AnalyzeText(font, html, false).ToList();
...
wish where we held steepest True he questions eat Thoughts";
		...
		[TestMethod]
		public void AnalyzeTextWithReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
...
";
			...
			var result = _classUnderTest.AnalyzeText(font, html, true).ToList();
		...
		[TestMethod]
		public void AnalyzeTextStartsAndEndsWithPTagReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
...
<p>directly part mirth</p>";
		...
		[TestMethod]
		public void AnalyzeTextAttributesReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
		...
		[TestMethod]
		public void AnalyzeTextFontTagsReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
...
<u>newspaper own come as its</u>";
		...
		[TestMethod]
		public void AnalyzeTextListTagsReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
...
<li>if Off supposing moment</li>
		...
		[TestMethod]
		public void AnalyzeTextNumericListTagsReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
...
<li>very you get up speedily</li>
		...
		[TestMethod]
		public void AnalyzeTextEmbeddedListTagsReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
...
wish where we held steepest True he questions eat Thoughts";
		...
		[TestMethod]
		public void AnalyzeTextTwoEmbeddedListTagsReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
		...
		[TestMethod]
		public void AnalyzeTextTwoEmbeddedListTagsWithPTagReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
		...
		[TestMethod]
		public void AnalyzeTextTwoEmbeddedListTagsWithPTag2ReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
		...
		[TestMethod]
		public void AnalyzeTextTwoEmbeddedListTagsWithPTag3ReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
		...
		[TestMethod]
		public void AnalyzeTextOnlyPTagsReducedLineBreaksForListsTest()
		{
			var font = new Font
			{
				Color = "#000000",
...
wish where we held steepest True he questions eat Thoughts";
			...
			expectedResult.Append("<p>very you get up speedily if Off supposing moment</p>");
			...
			expectedResult.Append("</ul>");
			expectedResult.Append("<p>wish where we held steepest True he questions eat Thoughts</p>");
